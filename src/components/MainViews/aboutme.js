...
function AboutMe() {
    return (
        <div id="about">
            ...
            <p>Hi! I'm Andrew. As a Senior Demo Solutions Engineer at Iterable, I build demo experiences that help our customers intuitively understand how our marketing software can help them reach their customers. In previous roles, I have worked as a Computational Linguist at <a className="linkonpage" target="_blank" rel="noreferrer" href="https://www.expert.ai">Expert.ai</a> and <a className="linkonpage" target="_blank" rel="noreferrer" href="https://www.datapeople.io">Datapeople</a>. I'm also the Founder of <a className="linkonpage" target="_blank" rel="noreferrer" href="https://www.getreadefine.com">Readefine</a>.</p>
