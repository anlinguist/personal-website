    ...
    return (
        <div id="portfolio">
            ...
            <ul>
                ...
                <p>Biblacra is an app that renders Hebrew and Greek biblical texts. There are 3 frontend Bibliacra clients: a web app, an iOS app, and an android app (android is still in testing). I used React.js for the web app and React Native to build the iOS and android versions. The database is a NoSQL Firestore database. Users of Biblia Sacra can open various texts, click on a word, and see word attributes like part of speech or gloss. In addition, users can search for words and Biblia Sacra queries an Algolia full text search engine and renders the results.</p>
                <li>This website!</li>
